...
Route::post('admin/product/store', 'App\Http\Controllers\Admin\AdminProductController@store')
    ->name("admin.product.store");

Route::delete('admin/product/{id}/delete', 'App\Http\Controllers\Admin\AdminProductController@delete')
